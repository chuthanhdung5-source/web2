  ...
  return (
    <div>
      <div className="page-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <h1>📅 Thời khóa biểu & Phân công</h1>
          <p>Quản lý lịch học, phân công thành viên và theo dõi TKB tuần</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
          ...
          <p>Bấm "Tạo ca tuần này" để tự động tạo từ thời khóa biểu mẫu</p>
        </div>
      ) : viewMode === 'grid' ? (
        <TimetableGrid
        ...
        <div className="table-wrapper">
          <table>
            <thead>
              <tr>
                <th>Ngày</th><th>Thứ</th><th>Môn học</th><th>Tiết</th><th>Giờ</th><th>Phòng</th><th>Trạng thái</th><th>Phân công người dùng</th>
              </tr>
            </thead>
            <tbody>
              {sessions.map(s => (
